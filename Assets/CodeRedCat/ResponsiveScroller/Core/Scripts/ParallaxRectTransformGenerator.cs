...
namespace CodeRedCat.ResponsiveScroller.Core.Scripts
{
    public class ParallaxRectTransformGenerator : MonoBehaviour
    {
        ...
        public void Init()
        {
            _lastOrthographicSize = BackgroundManager.cameraRef.orthographicSize;
        ...
        public void ImagesToScreen(bool optionChanged)
        {
            ...
            System.Diagnostics.Debug.Assert(BackgroundManager.cameraRef != null, nameof(BackgroundManager.cameraRef) + " != null");
            if (_lastScreenSize == screenResolution && !optionChanged && BackgroundManager.cameraRef.orthographicSize == _lastOrthographicSize) return;
            ...
            Vector2 rectSize = BackgroundManager.cameraRef.WorldToScreenPoint(rectCorners[2]) - BackgroundManager.cameraRef.WorldToScreenPoint(rectCorners[0]);
