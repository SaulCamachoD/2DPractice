...
namespace CodeRedCat.ResponsiveScroller.Core.Scripts
{
    ...
    {
        [Tooltip("The referenced camera for this background manager.")]
        ...
        void Awake()
        {
            ...
            _startCameraSize = cameraRef.orthographicSize;
        ...
        private void Update()
        {
            ...
            if (cameraRef.orthographicSize < 0) return;
        ...
        {
            float newOrthographicSize = cameraRef.orthographicSize;
        ...
        {
            return threeDimensionalEffectFactor.Evaluate(cameraRef.orthographicSize / _startCameraSize);
        }
